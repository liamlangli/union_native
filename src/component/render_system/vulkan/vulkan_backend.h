...
VkPipeline vk_create_graphics_pipeline(VkDevice *device, VkPipelineLayout *pipeline_layout, VkShaderModule *vertex_shader_module, const char *vertex_entry, VkShaderModule *fragment_shader_module, const char *fragment_entry, VkRenderPass *pass, VkExtent2D *extent);
