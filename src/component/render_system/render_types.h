...
enum { RENDER_SHADER_STAGE_COUNT = 11 };

typedef enum render_shader_stage {
    RENDER_SHADER_STAGE_VERTEX = 0x1u,
    RENDER_SHADER_STAGE_HULL = 0x2u,
    RENDER_SHADER_STAGE_DOMAIN = 0x4u,
    RENDER_SHADER_STAGE_GEOMETRY = 0x8u
    RENDER_SHADER_STAGE_PIXEL = 0x10u,
    
    RENDER_SHADER_STAGE_COMPUTE = 0x20u,
    
    RENDER_SHADER_STAGE_RAYGEN = 0x40u,
    RENDER_SHADER_STAGE_ANY_HIT = 0x80u,
    RENDER_SHADER_STAGE_CLOSEST_HIT = 0x100u,
    RENDER_SHADER_STAGE_MISS 0x200u,
    RENDER_SHADER_STAGE_INTERSECTION 0x400u,
} render_shader_stage;
