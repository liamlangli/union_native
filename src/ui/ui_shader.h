...
"\n"
"highp uvec4 fetch_primitive_buffer(const uint pixel_index) {\n"
"    uint width = uint(textureSize(primitive_buffer, 0).x);\n"
"    uint y = pixel_index / width;\n"
"    uint x = pixel_index % width;\n"
"    return floatBitsToUint(texelFetch(primitive_buffer, ivec2(x, y), 0));\n"
"}\n"
"\n"
...
"\n"
"        highp uvec4 glyph_data = fetch_primitive_buffer(ptr);\n"
"        highp uvec4 glyph_header = fetch_primitive_buffer(header_ptr);\n"
"        float glpyh_scale = uintBitsToFloat(glyph_data.w);\n"
"\n"
"        highp uint font_ptr = glyph_header.z;\n"
"        highp uvec4 font_data = fetch_primitive_buffer(font_ptr);\n"
"        highp uint glyph_ptr = font_ptr + 2u + glyph_data.y * 2u;\n"
"        vec2 font_texture_size = uintBitsToFloat(font_data.xy);\n"
"\n"
"        vec2 glyph_origin = uintBitsToFloat(glyph_header.xy);\n"
"        highp uvec4 glyph_sample_rect = fetch_primitive_buffer(glyph_ptr);\n"
"        highp uvec4 glyph_sample_data = fetch_primitive_buffer(glyph_ptr + 1u);\n"
"\n"
"        vec4 primitive_rect = vec4(glyph_origin + vec2(uintBitsToFloat(glyph_data.x), uintBitsToFloat(glyph_sample_data.y) * glpyh_scale), uintBitsToFloat(glyph_sample_rect.zw) * glpyh_scale);\n"
"\n"
"        v.xy = rect_vertex(primitive_rect, corner_id).xy;\n"
"        color = decode_color(glyph_data.z);\n"
"        highp uint raw_clip = glyph_header.w;\n"
"        clip = raw_clip == 0u ? 0u : header_ptr - raw_clip;\n"
"\n"
"        sample_point = rect_vertex(uintBitsToFloat(glyph_sample_rect), corner_id).xy / font_texture_size;\n"
...
"\n"
"            highp uint corner_id = decode_corner_idx(vertex_id);\n"
"            highp uvec4 primitive_data = fetch_primitive_buffer(ptr);\n"
"            highp uvec4 rect_data = fetch_primitive_buffer(ptr + 1u);\n"
"\n"
"            v = rect_vertex(uintBitsToFloat(primitive_data), corner_id);\n"
...
"\n"
"            highp uvec4 primitive_data = fetch_primitive_buffer(ptr);\n"
"            v.xy = uintBitsToFloat(primitive_data.xy);\n"
"            color = decode_color(primitive_data.z);\n"
"            highp uint raw_clip = primitive_data.w;\n"
"            clip = raw_clip == 0u ? 0u : ptr - raw_clip;\n"
"\n"
"        } else {\n"
"\n"
...
"            clip = raw_clip == 0u ? 0u : ptr - raw_clip;\n"
"\n"
"            uvec4 sample_data = fetch_primitive_buffer(ptr + 1u);\n"
"            sample_point = uintBitsToFloat(sample_data.xy);\n"
"\n"
"            type = sample_data.z;\n"
"        }\n"
"    }\n"
"\n"
"    if (clip != 0u) {\n"
"        clip_rect = uintBitsToFloat(fetch_primitive_buffer(clip));\n"
"    }\n"
"\n"
"    screen_point = v.xy;\n"
"\n"
